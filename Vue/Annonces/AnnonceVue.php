...
<html lang="fr">
  ...
  <body>
    ...
    <div class="container">
      ...
      echo '<div class  = "card-panel blue lighten-3 col s5" style="font-style: italic;" > Les recherches </div>';
      echo '<div class  = "card-panel grey lighten-5 col s5" style="font-style: italic;" > Les propositions </div>';
